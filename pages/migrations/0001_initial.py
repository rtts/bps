# -*- coding: utf-8 -*-
# Generated by Django 1.11.23 on 2020-02-07 10:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_pages.section_set+', to='contenttypes.ContentType')),
            ],
            options={
